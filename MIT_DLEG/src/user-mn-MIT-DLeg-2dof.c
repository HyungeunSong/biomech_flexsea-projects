...
//					rigid1.mn.genVar[4] = (int16_t) (cubicSpline.Y*100.0); // cubic spline desired theta-deg
					rigid1.mn.genVar[5] = (int16_t) (rigid1.ex.mot_acc); //motor acc. was: (stateMachine.current_state);
					rigid1.mn.genVar[6] = (int16_t) (JIM_LG); // LG
					rigid1.mn.genVar[7] = (int16_t) (JIM_TA); // TA
					rigid1.mn.genVar[8] = (int16_t) (stateMachine.current_state);
